...
class GyrtRateMultipliersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gyrt_rate_multiplier" do
    assert_difference("GyrtRateMultiplier.count") do
      post gyrt_rate_multipliers_url, params: { gyrt_rate_multiplier: { benefit_id: @gyrt_rate_multiplier.benefit_id, max_count: @gyrt_rate_multiplier.max_count, min_count: @gyrt_rate_multiplier.min_count, rate: @gyrt_rate_multiplier.rate } }
    end
  ...
  test "should update gyrt_rate_multiplier" do
    patch gyrt_rate_multiplier_url(@gyrt_rate_multiplier), params: { gyrt_rate_multiplier: { benefit_id: @gyrt_rate_multiplier.benefit_id, max_count: @gyrt_rate_multiplier.max_count, min_count: @gyrt_rate_multiplier.min_count, rate: @gyrt_rate_multiplier.rate } }
