...
class BenefitsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create benefit" do
    assert_difference("Benefit.count") do
      post benefits_url, params: { benefit: { description: @benefit.description, name: @benefit.name, short_name: @benefit.short_name } }
    end
  ...
  test "should update benefit" do
    patch benefit_url(@benefit), params: { benefit: { description: @benefit.description, name: @benefit.name, short_name: @benefit.short_name } }
