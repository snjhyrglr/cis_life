...
class GyrtRatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gyrt_rate" do
    assert_difference("GyrtRate.count") do
      post gyrt_rates_url, params: { gyrt_rate: { age: @gyrt_rate.age, benefit_id: @gyrt_rate.benefit_id, rate: @gyrt_rate.rate } }
    end
  ...
  test "should update gyrt_rate" do
    patch gyrt_rate_url(@gyrt_rate), params: { gyrt_rate: { age: @gyrt_rate.age, benefit_id: @gyrt_rate.benefit_id, rate: @gyrt_rate.rate } }
